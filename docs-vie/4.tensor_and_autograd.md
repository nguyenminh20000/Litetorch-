...
LiteTorch hỗ trợ 4 loại thiết bị:
...
- `lt.DeviceType.TPU`: Tính toán trên Google Cloud TPU (từ v2-v5p, v6e Trillium, v7 Ironwood, đến v8 8t/8i thông qua PJRT và `libtpu.so` Systolic MXU).
