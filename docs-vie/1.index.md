...
5. **Đa nền tảng phần cứng**: Tự động nhận diện NVIDIA CUDA, Google Cloud TPU (v2-v5p, v6e Trillium, v7 Ironwood, v8 8t/8i qua PJRT và `libtpu.so`), AMD ROCm, OpenCL hoặc CPU đa luồng.
